...
***Descriptives and tests of normality for individual item-level
...
***Descriptives and tests of normality for compositive level

FREQUENCIES VARIABLES=purposecomp engagecomp energycomp calmcomp focuscomp flowcomp valuescomp 
    mindfulcomp emoregcomp resiliencecomp growthmindcomp controlcomp risktolcomp opencomcomp 
    participationcomp relbuildingcomp trustclimatecomp motivatingcomp coachingcomp recogcomp encowncomp 
    aligncomp probsolvecomp feedbackcomp influencecomp burnoutcomp stresscomp mindlesscomp
  /FORMAT=NOTABLE
  /STATISTICS=STDDEV MINIMUM MAXIMUM MEAN MEDIAN SKEWNESS SESKEW KURTOSIS SEKURT
  /HISTOGRAM NORMAL
  /ORDER=ANALYSIS.
